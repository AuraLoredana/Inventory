package com.example.popescu.inventory;
...
import com.example.popescu.inventory.ProductContract;
public class PropertiesActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
        ...
        mDecreaseQuantityByOneButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mProductQuantity > 0) {
                    ...
                    Toast.makeText(PropertiesActivity.this, getString(R.string.invalid_product_quantity_toast), Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        mIncreaseQuantityLargeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(mQuantityEditText.getText()) && Integer.valueOf(mQuantityEditText.getText().toString()) > 0) {
                    ...
                    Toast.makeText(PropertiesActivity.this, getString(R.string.invalid_product_quantity_modifier_toast), Toast.LENGTH_SHORT).show();
                }
            }
        });
